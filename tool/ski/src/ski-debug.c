...
void ski_control_parameters_print(ski_stats *stats){
	...
	assert(ski_control_parameters_fd);
    fprintf(ski_control_parameters_fd, "T: %s S: %d I1: %d I2: %d Slot: %d Pid: %d P_size: %d P_points: %s P_exec: %d C_data: %d C_eips: %d Dur: %d.%06d TI: %lld #I: %lld #D: %lld Exit: %s %s CPU0_preemption_ins: %x CPU1_preemption_ins: %x preemption_mem: %x CPU0_pmc_happened: %d CPU1_pmc_happened: %d\n",
		trace_filename,
        ...
        stats->cpu0_preemption_point,
        stats->cpu1_preemption_point,
        stats->ski_communication_addr,
        stats->ski_cpu0_accessed,
        stats->ski_cpu1_accessed);
}
